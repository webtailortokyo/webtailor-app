...
export const ui = {
  ja: {
    ...
    'contact.success.message': 'お問い合わせありがとうございます。内容を確認次第、順次ご連絡させていただきます。',
    'contact.success.back': 'ホームへ戻る',
    ...
    'message.main_site_text': 'WEB制作などの主な事業やポートフォリオについては、本家サイトをご覧ください。',
    'message.main_site_link': 'WEBテーラー本家サイトへ',
  },
  en: {
    'nav.home': 'Home',
    'nav.apps': 'Apps',
    ...
    'contact.success.message': 'Thank you for contacting us. We will get back to you as soon as possible.',
    ...
    'message.main_site_text': 'For information on my main web production business and portfolio, please visit my main site.',
    'message.main_site_link': 'Visit WEB TAILOR Main Site',
  },
} as const;
